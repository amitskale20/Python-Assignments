...
if root_index >= 0:
    ...
    root_feature = feature_cols[root_index]
    ...
    print(
        "The feature at the root provides the best split "
        "for separating Pass and Fail students."
    )


####################################
# Step 9 : PerformanceIndex
####################################

print(Border)
print("Step 9 : PerformanceIndex")
print(Border)
...
print(
    ...
    f"{accuracy_new * 100:.2f}%"
)


if accuracy_new > original_accuracy:

    print(
        "Accuracy improved after adding PerformanceIndex."
    )

elif accuracy_new == original_accuracy:
...
####################################
# Step 10 : max_depth = None
####################################

print(Border)
print("Step 10 : max_depth = None")
print(Border)
...
Y_train_pred = model_none.predict(
    X_train
)

Y_test_pred = model_none.predict(
    X_test
)
...
if (
    ...
    print(
        ...
        "and performs worse on unseen testing data."
    )

elif training_accuracy == testing_accuracy:

    print(
        "\nObservation: Training and testing accuracy "
        "are the same."
    )

    print(
        "There is no clear evidence of overfitting "
        "from this train-test split."
    )

...
if len(outliers) == 0:
    print("No significant outliers are present in Attendance.")
else:
...
plt.title(
    "Assignments Completed vs Final Result"
)
...
print(
    "Students who completed more assignments generally "
    "had a higher chance of passing."
)

print(
    "Students completing 2 to 4 assignments are mainly "
    "in the Fail category."
)

print(
    "Students completing 6 or more assignments are mainly "
...
print(
    "Average SleepHours of Fail students:",
    round(sleep_result[0], 2)
)

print(
    "Average SleepHours of Pass students:",
    round(sleep_result[1], 2)
)

print(
    "\nStudents who passed generally have higher average "
    "sleep hours than students who failed."
)
...
print(
    "Other factors such as StudyHours, Attendance, "
    "PreviousScore and AssignmentsCompleted also affect "
    "student performance."
)